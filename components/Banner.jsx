...
const Banner = () => {
  return (
    <>
      <section className="banner relative w-full h-screen bg-[url('/banner-bg.png')] bg-cover bg-no-repeat bg-top pt-52 pb-24">
        <div className="container mx-auto">
          <div className="flex">
            <div className="mx-auto lg:mx-0 w-10/12 xl:w-7/12">
              ...
              <div className="text-6xl text-center md:text-left font-bold tracking-wide mb-5 text-white">
                Hi I am Tehseen
                <br />
                <span className="text-purple-600 drop-shadow-lg md:text-6xl">
